 ...
 * @LastEditTime: 2023-12-26 15:07:34
 * @Description: echarts-雷达图图表配置方法
 */
...
export interface radarChartData extends IBaseChartOption {
  series: echarts.RadarSeriesOption
  radar: echarts.RadarComponentOption
}
export function radarOption(params: radarChartData) {
  const { series, radar } = params || { series: [] }
