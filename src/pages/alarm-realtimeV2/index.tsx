 ...
 * @LastEditTime: 2025-07-24 15:30:58
 * @Description:
 */
import "./index.less"
...
import { CardParams, IChooseForm, TableParams } from "./config/types"
import { IQueryAlarmParams } from "./config/types"
import { bacthPass, doExportRealtime, getAlarmLevelByDvsTypes, getRealAlarmCounts, serialNumber } from "./methods"
import { useRefresh } from "@/hooks/use-refresh"
import { EXPORT_LIST1 } from "@/configs/option-const"
import PropertyBox from "@/components/property-checkbox"
import DetailModel, { IDtOperateProps, IDtPerateRef } from "./components/device-list-detail"
...
export default function AlarmCenter() {
  ...
  const [curChooseVal, setCurChooseVal] = useState<IChooseForm>({})
  ...
  return (
    <div className="alarm-real" ref={containerRef}>
      ...
      <CustomModal<IDtOperateProps, IDtPerateRef>
        ref={modeRef}
        width="70%"
        title="详情"
        destroyOnClose
        ...
        componentProps={{ data: operateOneAlarmData, property: property }}
      />
    </div>
  )
}
