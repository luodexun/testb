 ...
 * @LastEditTime: 2025-10-13 11:17:04
 * @Description:
 */
import "./index.less"
...
import LogModal from "../../../area-state-overview/components/log-modal"
...
export default function DeviceDetail(props) {
  ...
  const { drawerOpenMap, setDevice, device, closeCtxMenu, setCloseCtxMenu, chooseColumnKey, needShangdevice } =
