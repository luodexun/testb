/*
 * @Author: chenmeifeng
 * @Date: 2024-01-11 15:41:09
 * @LastEditors: chenmeifeng
 * @LastEditTime: 2025-07-22 16:36:43
 * @Description:
 */
import "./index.less"
...
export default function AreaStateList(props) {
  const { deviceType, setState, chooseAll, combineData, showCount = true } = props
                ...
                return (
                  <div key={state.id} className="item-children">
                    ...
                    >
                      ...
                      <span className="state-name">{`${state.stateDesc}${showCount ? '('+state.num+')' : ''}`}</span>
                    </div>
                  </div>
                )
              })}
