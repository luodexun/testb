/*
 * @Author: chenmeifeng
 * @Date: 2024-04-11 09:48:10
 * @LastEditors: chenmeifeng
 * @LastEditTime: 2024-09-19 14:12:33
 * @Description:
 */
import "./site-list-detail.less"
...
export default function HbStLsDetail() {
  ...
  return (
    <div className="screen-box site-view">
      <HBCommonTitle
        title="场站详情"
        children={
          <ComRadioClk
      ...
      />
      <div className="site-view-content screen-box-content">
        <CustomTable
          ref={tableRef}
          rowKey="id"
          size="small"
