/*
 * @Author: chenmeifeng
 * @Date: 2024-03-21 09:54:21
 * @LastEditors: chenmeifeng
 * @LastEditTime: 2024-03-28 17:03:36
 * @Description:
 */
import "echarts-gl"
...
export function Brand3DPie(params) {
  //
}

//配置构建 pieData 饼图数据 internalDiameterRatio:透明的空心占比
export const getPie3D = (props) => {
  const { pieData, internalDiameterRatio, name, screenWidth } = props || {
    pieData: [],
  ...
  const option = {
    ...
    labelLine: {
      show: true,
      length: 30 * (screenWidth / 4513),
      length2: 140 * (screenWidth / 4513),
      lineStyle: {
        width: 4,
      },
    },
