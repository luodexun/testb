 ...
 * @LastEditTime: 2024-12-09 14:15:35
 *@Description:
 */
...
export async function getReportHnSchData(pageInfo: IPageInfo, formData: IRpOperationSchForm) {
  ...
  const res = await doRecordServer<IRpOperationSchParams>("getHubeiData", params)
...
export function reportGridExport(formData: IRpOperationSchForm) {
  const params = dealParams(formData)
  doBaseServer<typeof params, AxiosResponse>("exportHubeiData", params).then((data) => {
    dealDownload4Response(data, "现货报表.xlsx")
  })
}
