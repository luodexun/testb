...
const getMapName = (name) => {
  if (!name) return "河南"
  return name === "河南" ? "河南框" : name
}
export function geoOption(params: geoChartData) {
  const { series, screenWidth, mapName, large } = params || { series: [], large: false, mapName: "河南" }
    ...
    geo: [
      ...
      },
      {
        ...
        itemStyle: {
          ...
          borderColor: mapName === "河南" ? "rgba(207, 228, 245, 0.27)" : "#c0f3fb",
          borderWidth: 1,
          borderType: mapName === "河南" ? "dashed" : "solid",
          shadowColor: "#8cd3ef",
          // shadowOffsetY: 10,
