...
export default function JsCenter() {
  ...
  return (
    <HbScreenContext.Provider value={{ quotaInfo, setQuotaInfo }}>
      <div className="js-center">
        <div className="js-center-left">
          <WtState />
        </div>
        <div className="js-center-left2">
          <JsCenterLeft />
        </div>
        <div className="js-center-map">
          <JsCenterMap />
        </div>
        <div className="js-center-right">
          <JsCenterRight />
        </div>
      </div>
