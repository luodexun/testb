 ...
 * @LastEditTime: 2024-07-03 16:29:03
  ...
  const actTooltip = {
    ...
    formatter: function (params) {
      ...
      for (let i = 0; i < params.length; i++) {
        res += `<div style="font-size: 12px;line-height: 1.2em">${params[i].marker} ${params[i].seriesName} : <span style="color: #00F7FA">${parseNum(params[i].data)}</span> ${unit} </div>`
      }
      return res
    },
  }
