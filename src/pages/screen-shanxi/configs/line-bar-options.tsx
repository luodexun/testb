 ...
 * @LastEditTime: 2024-11-21 17:25:32
  ...
  const actTooltip = {
    ...
    formatter: function (params) {
      ...
      for (let i = 0; i < params.length; i++) {
        res += `<div style="font-size: 12px;line-height: 1.2em">${params[i].marker} ${params[i].seriesName} : <span style="color: #00F7FA">${judgeNull(params[i].data, 1, 2, "-")}</span> ${unit} </div>`
      }
      return res
    },
  }
